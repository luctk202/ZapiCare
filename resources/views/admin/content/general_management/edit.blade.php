...
@section('title', 'Sửa quản lí chung')
...
@section('content')
    <form method="POST" id="form_create_product" action="{{ route('admin.generalManagement.update',$generalManagement->id) }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="title" class="form-control title" name="title" placeholder=""
                                       value="{{ old('title') ?? $generalManagement->title }}">
                                @error('title')
                            ...
                            <div class="col-md-6">
                                ...
                                <input  type="text" id="slug" class="form-control slug" name="slug" placeholder=""
                                        value="{{ old('slug') ?? $generalManagement->slug }}">
                                @error('slug')
                                <span class="form-text text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="">
                            ...
                            <textarea class="form-control" name="content"
                                      id="description">{!! old('content') ?? $generalManagement->content !!}</textarea>
                            @error('content')
                            <span class="form-text text-danger">{{ $message }}</span>
                            @enderror
