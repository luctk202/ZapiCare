...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.customer.update', ['customer' => $user->id]) }}">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="mb-1 row">
...
{{--                                       placeholder="" value="{{ old('code', $user->code) }}">--}}
{{--                            </div>--}}
{{--                            @error('code')--}}
{{--                            <span class="form-text text-danger">{{ $message }}</span>--}}
{{--                            @enderror--}}
...
@section('page-script')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            let referred_by = `{{ old('parent_id', $user->parent_id) }}`
            let referred_name = `{{ old('parent_name', $ctv->name ?? '') }}`
