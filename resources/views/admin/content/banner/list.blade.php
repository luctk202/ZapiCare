                ...
                <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('admin.banner.create') }}" class="btn btn-success">Tạo banner</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <td>
                                    <div class="form-check form-check-primary form-switch">
                                        <input type="checkbox" data-id="{{ $banner->id }}"
                                               @if($banner->status == \App\Repositories\Banner\BannerRepository::STATUS_ACTIVE) checked="true"
                                               @endif class="form-check-input js_update_status"/>
                                    </div>
                                </td>
                                <td>
                                    {{ date('d-m-Y', $banner->start_time) . ' to ' .  date('d-m-Y', $banner->end_time) }}
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button type="button"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                               href="{{ route('admin.banner.edit',['banner' => $banner->id]) }}">
