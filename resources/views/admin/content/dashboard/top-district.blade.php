...
@section('content')
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a
                    class="nav-link"
                    id="home-tab"
                    href="{{ route('admin.report.top-province') }}"
            >Tỉnh thành</a
            >
        </li>
        <li class="nav-item">
    ...
    <div class="card">
        <form method="GET" action="{{ route('admin.report.top-district') }}">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        <label class="form-label" for="province_id">Tỉnh thành</label>
                        <select class="form-select" id="province_id" name="province_id">
                            <option value="0">Vui lòng chọn</option>
                            @foreach($provinces as $k => $v)
                                <option value="{{ $k }}"
                                        @if(request('province_id', 0) == $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
