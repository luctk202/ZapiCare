...
{{--                                <option value="{{ old('source_id') }}" selected>{{ old('source_name') }}</option>--}}
{{--                            </select>--}}
{{--                        </div>--}}
...
{{--                    </div>--}}
                    ...
                    <div class="col-sm-12 mb-1">
                        ...
                        <input type="text" class="form-control" name="discount_max_value" value="{{old('discount_max_value', 0)}}">
                    ...
                    <div class="col-sm-12 mb-1">
                        ...
                        <input type="text" class="form-control" name="num" value="{{old('num', 0)}}">
                        @error('num')
                        <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-sm-12 mb-1">
                        ...
                        <input type="text" class="form-control" name="max_per_person" value="{{old('max_per_person', 1)}}">
                    ...
                    <div class="col-sm-12 mb-1">
                        ...
                        <input type="text" class="form-control" name="min_total_order" value="{{old('min_total_order', 0)}}">
...
{{--                                <option value="0" @if(0 == old('concurrency', 0)) selected @endif>Không</option>--}}
{{--                                <option value="1" @if(1 == old('concurrency', 0)) selected @endif>Có</option>--}}
{{--                            </select>--}}
{{--                        </div>--}}
{{--                        @error('category_id')--}}
{{--                        <span class="form-text text-danger">{{ $message }}</span>--}}
