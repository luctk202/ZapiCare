...
@section('content')
    ...
    <div class="card">
        <form method="GET" action="{{ route('admin.disease.index') }}">
            <div class="card-body">
                ...
                <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('admin.disease.create') }}" class="btn btn-success">Thêm bệnh lý</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center col-actions">
                                            <a class="me-2" href="{{ route('admin.disease.edit',['disease' => $dt->id]) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.js_btn_delete').on('click', function () {
                ...
                Swal.fire({
                    title: 'Xác nhân xóa',
                    text: "Bạn chắc chắn muốn xóa bệnh lý này ?",
                    /*icon: 'warning',*/
