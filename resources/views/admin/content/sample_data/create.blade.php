...
@section('content')
    <form method="POST" id="form_create_product" action="{{ route('admin.sample-data.store') }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <label class="col-form-label" for="test_item_id">Tên mục kiểm tra <span class="text-danger">*</span></label>
                                <select class="form-select select2s" name="test_item_id" id="test_item_id">
                                    ...
                                    @foreach ($test_items as $value)
                                        <option value="{{ $value->id }}" @if ($value->id == old('test_item_id')) selected @endif>
...
{{--                            <div class="col-lg-3 col-md-6">--}}
{{--                                <label class="col-form-label" for="level_id">Cấp độ <span class="text-danger">*</span></label>--}}
{{--                                <select class="form-select select2s" name="level_id" id="level_id">--}}
{{--                                    <option value="0" selected>Vui lòng chọn</option>--}}
{{--                                    @foreach ($levels as $value)--}}
{{--                                        <option value="{{ $value->id }}" @if ($value->id == old('level_id')) selected @endif>--}}
{{--                                            {{ $value->prefix . $value->name }}</option>--}}
{{--                                    @endforeach--}}
{{--                                </select>--}}
{{--                                @error('level_id')--}}
...
{{--                                <input type="text" id="range_min" class="form-control" name="range_min" value="{{ old('range_min') }}">--}}
{{--                                @error('range_min')--}}
{{--                                <span class="form-text text-danger">{{ $message }}</span>--}}
{{--                                @enderror--}}
{{--                            </div>--}}
...
{{--                                <input type="text" id="range_max" class="form-control" name="range_max" value="{{ old('range_max') }}">--}}
{{--                                @error('range_max')--}}
{{--                                <span class="form-text text-danger">{{ $message }}</span>--}}
{{--                                @enderror--}}
{{--                            </div>--}}
{{--                            <div class="col-lg-2 col-md-6">--}}
{{--                                <label class="col-form-label" for="is_normal_range">Bình thường</label>--}}
{{--                                <div class="d-flex align-items-center">--}}
{{--                                    <input type="checkbox" id="is_normal_range" name="is_normal_range" class="form-check-input">--}}
{{--                                </div>--}}
{{--                            </div>--}}
                        </div>
                        <div class="">
                        ...
                        <div class="">
                            ...
                            <textarea id="symptom" class="form-control" name="symptom">{{ old('symptom') }}</textarea>
                            @error('symptom')
                            <span class="form-text text-danger">{{ $message }}</span>
                            @enderror
                        </div>
...
{{--                            <textarea id="disease" class="form-control" name="disease">{{ old('disease') }}</textarea>--}}
{{--                            @error('disease')--}}
{{--                            <span class="form-text text-danger">{{ $message }}</span>--}}
{{--                            @enderror--}}
{{--                        </div>--}}
                        <div class="">
                            <label class="col-form-label" for="">Bệnh lý thường gặp <span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2s" name="disease_ids[]" id="disease_id" multiple>
                                @foreach ($diseases as $value)
                                    <option value="{{ $value->id }}"
                                            @if (is_array(old('disease_ids')) && in_array($value->id, old('disease_ids'))) selected @endif>
                                        {{$value->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="">
                            ...
                            <textarea id="advice" class="form-control" name="advice">{{ old('advice') }}</textarea>
                            @error('advice')
                            <span class="form-text text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="">
                            <label class="col-form-label" for="category_id">Sản phẩm gợi ý <span
                                    class="text-danger">*</span></label>
                            <select class="form-select select2s" name="product_ids[]" id="product_id" multiple>
                                @foreach ($products as $value)
                                    <option value="{{ $value->id }}"
                                            @if (is_array(old('product_ids')) && in_array($value->id, old('product_ids'))) selected @endif>
