                        ...
                        <div class="col-sm-9">
                            <div class="mb-1">
                                <select class="form-select" id="partner_id" name="partner_id">
                                    <option value="{{ old('partner_id') }}" selected>{{ old('partner_name') }}</option>
                                </select>
                            </div>
                            <input type="hidden" name="partner_name" id="partner_name" value="{{ old('partner_name') }}">
                            @error('partner_id')
                            <span class="form-text text-danger">{{ $message }}</span>
                            @enderror
                        </div>
...
@section('page-script')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            let partner_id = `{{ old('partner_id') }}`
            let partner_name = `{{ old('partner_name') }}`
