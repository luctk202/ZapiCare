        ...
        <form method="GET" action="{{ route('admin.shop.index') }}">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <label class="form-label" for="user_id">Quản lý cửa hàng</label>
                        <div class="mb-1">
                ...
                <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('admin.shop.create') }}" class="btn btn-success">Thêm cửa hàng</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <td>
                                    <div class="form-check form-check-primary form-switch">
                                        <input type="checkbox" data-id="{{ $zone->id }}"
                                               @if($zone->status == \App\Repositories\Shop\ShopRepository::STATUS_SHOW) checked="true"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                               href="{{ route('admin.shop.edit',['shop' => $zone->id]) }}">
        ...
        var ProSellPage = {
            updateStatus:function (id, status){
                if (ProSell.config.ajaxProcess === false) {
                    ...
                    Axios({
                        method: 'post',
                        url: '/admin/shop/update-status/'+id,
                        data:{status:status}
                    }).then(function (response) {
                        let res = response.data;
                        if (res.result === true) {
