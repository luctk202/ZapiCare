...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.discount.update', ['discount' => $data->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group input-group-merge">
                                    <input type="text" id="discount_total" class="form-control" name="discount_total"
                                           placeholder="" value="{{ old('discount_total', $data->discount_total) }}">
                                </div>
