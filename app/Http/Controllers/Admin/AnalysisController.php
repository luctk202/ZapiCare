...
class AnalysisController extends Controller
{
    ...
    public function create()
    {
        ...
        $categories = $this->categoryRepository->tree();
        return view('admin.content.banner.create')->with(compact('breadcrumbs', 'positions', 'categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = $this->categoryRepository->tree();
        return view('admin.content.banner.edit')->with(compact('breadcrumbs', 'positions', 'banner', 'categories'));
    }
